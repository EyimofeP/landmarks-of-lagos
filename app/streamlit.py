...
st.set_page_config(layout="wide", page_title="Landmarks of Lagos")
...
st.text("Please post external pictures of these landmarks, interiors may be predicted wrongly.\n Also expect False Positives if you upload a photo that isnt a landmark")
